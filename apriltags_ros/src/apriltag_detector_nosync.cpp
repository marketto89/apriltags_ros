...
//  image_sub_ = it_.subscribeCamera("image_rect", 1, &AprilTagDetector::imageCb, this);
  image_sub_nosync_ = it_.subscribe("image_rect", 1, &AprilTagDetector::rgbCb, this);
  info_sub_ = nh.subscribe<sensor_msgs::CameraInfo>("camera_info", 1, &AprilTagDetector::infoCb, this);
...
void AprilTagDetector::rgbCb(const sensor_msgs::ImageConstPtr& msg)
{
  if(no_camera_info_yet_) return;
...
void AprilTagDetector::infoCb(const sensor_msgs::CameraInfoConstPtr& cam_info)
{
